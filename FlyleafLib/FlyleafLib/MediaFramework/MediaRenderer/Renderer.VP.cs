...
public class VPConfig : NotifyPropertyChanged
{
    ...
    public System.Windows.Media.Color
                            BackColor               { get => VorticeToWPFColor(flBackColor);  set { Set(ref flBackColor, WPFToVorticeColor(value)); d3BackColor = WPFToVideoColor(value); vp?.VPRequest(VPRequestType.BackColor); } }
