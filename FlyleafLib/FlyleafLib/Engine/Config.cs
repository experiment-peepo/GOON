...
public class Config : NotifyPropertyChanged
{
    ...
    public class PlayerConfig : NotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Sets which clock to use as master (default: Video)
        /// </summary>
        public MasterClock MasterClock              { get; set; } = MasterClock.Video;
        
        /// <summary>
        /// Synchronization tolerance (ticks) for External Clock (default: 16ms)
        /// </summary>
        public long     SyncTolerance               { get; set; } = 16 * 10000;
    ...
    public class DemuxerConfig : NotifyPropertyChanged
    {
        public DemuxerConfig Clone()
        {
            ...
            demuxer.UserAgent           = UserAgent;
            demuxer.Cookies             = Cookies;
        ...
        /// <summary>
        /// Custom User-Agent header for the demuxer
        /// </summary>
        public string           UserAgent           { get; set; }

        /// <summary>
        /// Custom Cookies header for the demuxer
        /// </summary>
    ...
    public class VideoConfig : VPConfig
    {
       ...
       /// <summary>
        ...
        /// </summary>
        public SwsFlags         BitmapSubsScaleQuality      { get; set; } = (SwsFlags)0x2 | (SwsFlags)0x10000;
